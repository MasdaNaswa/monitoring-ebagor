<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <!-- Kategori Laporan (FR-29) -->
        <li class="nav-item">
          <a href="{{ route('adminpelayananpublik.kategori.index') }}">
            <i class="material-icons">category</i> <span>Kategori Laporan</span>
          </a>
        </li>
...
<script>
    ...
    // Toggle submenu dengan auto-close lainnya (sudah tidak ada submenu)
