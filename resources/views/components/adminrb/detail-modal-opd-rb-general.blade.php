<!-- Modal Detail -->
<div id="detailModal" class="hidden fixed inset-0 bg-black bg-opacity-40 items-center justify-center z-[9999] p-4">
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            ...
            <div class="mb-6 p-6 bg-purple-50 rounded-lg border-l-4 border-purple-500">
                <h3 class="text-md font-semibold text-purple-800 mb-4">Anggaran Tahun <span
                        id="detailTahunAnggaran">2025</span></h3>
