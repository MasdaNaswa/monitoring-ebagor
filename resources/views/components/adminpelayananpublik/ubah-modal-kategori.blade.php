<div id="editModal{{ $kategori['id_kategori'] }}" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-[9999]">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 animate-slide-in">
        ...
        <form action="{{ route('adminpelayananpublik.kategori.update', $kategori['id_kategori']) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="flex justify-end gap-3">
                <button type="button" onclick="closeModal('editModal{{ $kategori['id_kategori'] }}')"
