<div id="tambahTemplateModal" class="hidden fixed inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-50 px-4 py-6">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative">
        ...
        <form action="{{ route('adminpelayananpublik.template.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="flex justify-end gap-3 pt-4">
                <button type="button" onclick="closeModal('tambahTemplateModal')" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
                    Batal
                </button>
