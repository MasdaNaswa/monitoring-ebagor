...
<div id="editModal" class="hidden fixed inset-0 bg-black bg-opacity-40 z-[9999] p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-y-auto mx-auto my-auto">
        <!-- Modal Header -->
