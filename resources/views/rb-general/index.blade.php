...
<div class="flex flex-col min-h-screen">
    ...
    <main class="flex-1 px-4 md:px-8 py-6">
        <div class="flex flex-col md:flex-row justify-between items-center px-4 md:px-6 py-4 gap-4 md:gap-0">
            <div class="flex items-center gap-3">
                ...
                <select id="yearFilter" class="py-2 px-3 rounded border border-gray-300 hover:border-blue-500 transition focus:outline-none focus:ring-2 focus:ring-blue-200 text-sm md:text-base">
        ...
        <div class="bg-white shadow rounded-lg mt-6 overflow-hidden border border-gray-200">
            <div class="px-4 md:px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                ...
                <div class="relative w-full sm:w-auto">
                    ...
                    <input type="text" placeholder="Cari..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 w-full text-sm">
                </div>
            </div>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="py-3 px-4 text-left font-semibold text-gray-700 text-xs md:text-sm uppercase tracking-wider whitespace-nowrap border-b border-gray-200">Status</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr class="hover:bg-blue-50 transition-colors">
                            ...
                            <td class="py-3 px-4 text-sm">
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-1 rounded">75 (Nilai)</span>
                            </td>
                            <td class="py-3 px-4 text-sm">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex justify-center gap-1">
                                    ...
                                    <button class="p-2 text-blue-600 hover:bg-blue-100 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-200" 
            ...
            <div class="px-4 md:px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                ...
                <div class="flex space-x-1">
                    ...
                    <button class="px-3 py-1.5 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm">
                        1
                    </button>
                    <button class="px-2 py-1.5 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-300 text-sm">
    ...
    @include('components.ubah-modal')
    @include('components.detail-modal')
    @include('components.hapus-modal')

    <!-- Footer -->
    <footer class="bg-white shadow mt-auto">
        <div class="py-4 px-8 text-center text-gray-600 text-sm md:text-base">
            &copy; {{ date('Y') }} E-BAGOR. All rights reserved.
        </div>
    </footer>
</div>
