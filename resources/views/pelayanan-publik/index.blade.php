                                ...
                                <ul class="space-y-4">
                                    <li
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button class="p-2 border rounded hover:bg-blue-50 transition"><i
                                                    class="fas fa-download"></i></button>
                                            <button class="p-2 border rounded hover:bg-red-50 transition"><i
                                    ...
                                    <li
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded bg-yellow-100 text-yellow-600">Menunggu
                                                Verifikasi</span>
                                            <button class="p-2 border rounded hover:bg-blue-50 transition"><i
                                                    class="fas fa-download"></i></button>
                                            <button class="p-2 border rounded hover:bg-red-50 transition"><i
