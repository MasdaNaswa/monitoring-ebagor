        ...
        <ul class="space-y-4">
            <li class="flex items-center justify-between p-4 border rounded hover:shadow-md transition">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="px-2 py-1 text-xs font-medium rounded bg-gray-100 text-gray-700">Catatan: Dokumen lengkap dan sesuai format</span>
                    <i class="material-icons text-blue-600 cursor-pointer" title="Download">download</i>
                    <i class="material-icons text-red-600 cursor-pointer" title="Hapus"
                        onclick="openModal('hapusModal')">delete</i>
                </div>
            </li>
            ...
            <li class="flex items-center justify-between p-4 border rounded hover:shadow-md transition">
                ...
                <div class="flex items-center gap-2">
                    <span class="px-2 py-1 text-xs font-medium rounded bg-yellow-100 text-yellow-600">Menunggu Verifikasi</span>
                    <span class="px-2 py-1 text-xs font-medium rounded bg-gray-100 text-gray-700">Catatan: Perlu revisi format tabel</span>
                    <i class="material-icons text-blue-600 cursor-pointer" title="Download">download</i>
                    <i class="material-icons text-red-600 cursor-pointer" title="Hapus"
                        onclick="openModal('hapusModal')">delete</i>
                </div>
