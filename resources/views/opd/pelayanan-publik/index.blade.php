...
@section('content')
            ...
            <header class="bg-white shadow-sm py-4 px-6 sticky top-0 z-40 flex justify-between items-center">
                ...
                <div class="header-actions flex items-center gap-4">
                    <div class="profile-dropdown relative">
                        ...
                        <div
                            class="profile-dropdown-content absolute right-0 bg-white shadow-lg rounded-md py-2 min-w-[200px] hidden z-50">
                            <a href="../Admin/profil."
                                class="profile-dropdown-item flex items-center gap-3 px-4 py-2 text-gray-700 no-underline transition-all hover:bg-primary-light hover:text-primary">
                ...
                <div class="tab-container">
                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 mb-5">
                            ...
                            <div class="category-tabs flex border-b border-gray-200 mb-6">
                                <div class="category-tab py-2 px-5 cursor-pointer border-b-2 border-transparent transition-all text-gray-600"
                                    data-category="skm">Laporan SKM</div>
                                <div class="category-tab py-2 px-5 cursor-pointer border-b-2 border-transparent transition-all text-gray-600"
                                    data-category="fkp">Laporan FKP</div>
                            </div>
                            ...
                            <div class="category-contents">
                                ...
                                <div id="skm" class="category-content">
                                    <div class="template-list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                                        <div class="template-item flex items-start p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-primary hover:shadow-md"
                                            onclick="showPreview('Laporan SKM', '/templates/skm.docx', 'SKM')">
                                            <div class="template-icon mr-4 text-primary text-3xl"><i
                                                    class="fas fa-file-word"></i></div>
                                            <div class="template-info flex-1">
                                                ...
                                                <div class="template-periods flex flex-wrap gap-2">
                                                    <a href="/templates/skm-triwulan.docx"
                                                        class="btn-outline inline-flex items-center gap-1 bg-white border border-primary text-primary py-1 px-3 rounded text-sm hover:bg-primary-light"
                                                        download>Triwulan</a>
                                                    <a href="/templates/skm-semester.docx"
                                                        class="btn-outline inline-flex items-center gap-1 bg-white border border-primary text-primary py-1 px-3 rounded text-sm hover:bg-primary-light"
                                                        download>Semester</a>
                                                    <a href="/templates/skm-tahunan.docx"
                                                        class="btn-outline inline-flex items-center gap-1 bg-white border border-primary text-primary py-1 px-3 rounded text-sm hover:bg-primary-light"
                                                        download>Tahunan</a>
                                                </div>
                                            </div>
                                ...
                                <div id="fkp" class="category-content hidden">
                                    <div class="template-list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                                        <div class="template-item flex items-start p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-primary hover:shadow-md"
                                            onclick="showPreview('Berita Acara FKP', '/templates/fkp-berita-acara.docx', 'FKP')">
                                            <div class="template-icon mr-4 text-primary text-3xl"><i
                                                    class="fas fa-file-word"></i></div>
                                            <div class="template-info flex-1">
                                                <div class="template-name font-medium mb-1">Berita Acara FKP</div>
                                                <div class="template-desc text-sm text-gray-500 mb-3">Format berita acara
                                                    Forum Konsultasi Publik</div>
                                                <a href="/templates/fkp-berita-acara.docx"
                    ...
                    <div id="upload" class="tab-content hidden">
                        <div class="bg-white rounded-lg shadow-sm p-6 mb-5">
                            ...
                            <div class="upload-area border-2 border-dashed border-gray-300 rounded-lg p-8 text-center my-5 cursor-pointer hover:border-primary"
                                id="uploadArea">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow">
                                ...
                                <ul class="space-y-4">
                                    <li
                                        class="flex items-center justify-between p-4 border rounded hover:shadow-md transition">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-10 h-10 flex items-center justify-center rounded bg-blue-100 text-blue-600">
                                                <i class="fas fa-file-pdf"></i>
                                            </div>
                                            <div>
                                                <div class="font-medium">Analisis_Jabatan_2023.pdf</div>
                                                <div class="text-sm text-gray-500">Diunggah pada 12 Oktober 2023 - 12.5 MB
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded bg-green-100 text-green-600">Terverifikasi</span>
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded bg-gray-100 text-gray-700">Catatan:
                                                Lengkap</span>
                                            <i class="material-icons text-blue-600 cursor-pointer"
                                                title="Download">download</i>
                                            <i class="material-icons text-red-600 cursor-pointer" title="Hapus" onclick="openDeleteModal('hapusModal')">delete</i>
                                        </div>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-10 h-10 flex items-center justify-center rounded bg-green-100 text-green-600">
                                                <i class="fas fa-file-excel"></i>
                                            </div>
                                            <div>
                                                <div class="font-medium">Beban_Kerja_Q3.xlsx</div>
                                                <div class="text-sm text-gray-500">Diunggah pada 5 Oktober 2023 - 8.2 MB
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2">
                                    ...
                                    <li
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-500">Diunggah pada 28 September 2023 - 5.7 MB
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2">
    ...
    <!-- PREVIEW MODAL -->
    <div class="template-preview fixed inset-0 bg-black bg-opacity-80 z-50 flex items-center justify-center hidden"
        id="templatePreview">
        <div class="preview-container bg-white rounded-lg w-11/12 max-w-4xl max-h-[90vh] p-5 flex flex-col">
            ...
            <div class="preview-actions flex justify-end gap-3">
                <button
                    class="btn-outline bg-white border border-primary text-primary py-2 px-4 rounded hover:bg-primary-light"
                    onclick="closePreview()">
                    <i class="fas fa-times mr-1"></i> Tutup
                </button>
                <a id="downloadBtn"
                    class="btn-primary bg-primary text-white py-2 px-4 rounded flex items-center hover:bg-primary-dark"
                    download>
