...
@section('content')
    <div class="flex flex-col min-h-screen">
        ...
        <main class="flex-1 px-4 md:px-8 py-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            @php
                                $rbTematik = [
                                    (object) [
                                        ...
                                        'sasaran_tematik' => 'Reformasi Birokrasi Bidang Pelayanan Publik',
                            ...
                            @forelse($rbTematik as $index => $item)
                                <tr class="hover:bg-blue-50 transition-colors">
                                    ...
                                    <td class="py-3 px-4 text-sm">
                                        <span
                                            class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $item->status == 'draft' ? 'bg-amber-100 text-amber-800' : 'bg-green-100 text-green-800' }}">
                                            {{ ucfirst($item->status) }}
                                        </span>
                                    </td>
                                    <td class="py-3 px-4">
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="py-4 text-center text-gray-500">Tidak ada data RB Tematik</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <!-- Modals -->
            @include('components.tambah-modal-rb-tematik')
            @include('components.ubah-modal-rb-tematik')
            @include('components.detail-modal-rb-tematik')
