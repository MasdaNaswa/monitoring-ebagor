        ...
        <header class="bg-white shadow sticky top-0 z-30">
            <div class="flex justify-between items-center py-4 px-6 md:px-8">
                <h1 class="text-xl md:text-2xl font-semibold flex items-center gap-2">
                    <i class="fas fa-category text-blue-600"></i>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                <th
                                    class="py-3 px-4 text-left font-semibold text-gray-700 text-xs uppercase tracking-wider border-b">
                                    No</th>
                                <th
                                    class="py-3 px-4 text-left font-semibold text-gray-700 text-xs uppercase tracking-wider border-b">
                                    Nama Kategori</th>
                                <th
                                    class="py-3 px-4 text-center font-semibold text-gray-700 text-xs uppercase tracking-wider border-b">
                                    Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200">
                            @foreach($kategories as $kategori)
                                <tr class="hover:bg-blue-50 transition-colors">
                                    ...
                                    <td class="py-3 px-4 text-sm font-medium text-gray-900">{{ $kategori['nama_kategori'] }}
                                    </td>
                                    <td class="py-3 px-4">
                                        <div class="flex justify-center gap-2">
                                            <button onclick="openModal('editModal{{ $kategori['id'] }}')"
                                                class="p-2 text-yellow-600 hover:bg-yellow-100 rounded-lg">
                                                <i class="fas fa-edit text-sm"></i>
                                            </button>

                                            <button onclick="openModal('hapusModal{{ $kategori['id'] }}')"
