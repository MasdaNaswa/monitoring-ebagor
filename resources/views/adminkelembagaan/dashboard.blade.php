...
@section('content')
  ...
  <div class="flex flex-col min-h-screen">
    ...
    <div class="flex-1">
      ...
      <!-- Welcome -->
      <div class="welcome-container mt-8 mb-4 px-6 md:px-8">
        <h2 class="text-2xl font-semibold text-gray-800">Selamat Datang, Admin Kelembagaan</h2>
      </div>
      ...
      <div class="stats-container flex flex-wrap justify-center gap-6 px-6 md:px-8 mb-8">
        ...
        <div
          ...
          <div class="flex items-center justify-between mb-3">
            <h3 class="text-gray-700 font-semibold">Jumlah Akun Terdaftar</h3> <i
              class="fas fa-users text-blue-500 text-2xl"></i>
          </div>
        ...
        <div
          ...
          <div class="flex items-center justify-between mb-3">
            <h3 class="text-gray-700 font-semibold flex items-center gap-2"> Jumlah Dokumen <i
                class="fas fa-info-circle text-green-500 cursor-pointer"></i> </h3> <i
              class="fas fa-file-alt text-green-500 text-2xl"></i>
          </div>
          ...
          <div
            ...
            <ul class="space-y-1.5 text-[13px]">
              <li class="flex justify-between"><span>Diproses</span> <span
                  class="text-blue-400">{{ $dokumenProses ?? 0 }}</span> </li>
              <li class="flex justify-between"><span>Revisi</span> <span
                  class="text-yellow-400">{{ $dokumenRevisi ?? 0 }}</span> </li>
              <li class="flex justify-between"><span>Disetujui</span> <span
                  class="text-green-400">{{ $dokumenDisetujui ?? 0 }}</span> </li>
            </ul>
          </div>
        </div>
      </div>
